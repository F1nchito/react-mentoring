...
const search = (state = {searchFilter : initalState.searchFilter, query: initalState.query, isFetching : initalState.isFetching }, action) => {
    switch (action.type){
...
const sortFilter = (state = initalState.sortFilter, action) => {
    switch (action.type) {
